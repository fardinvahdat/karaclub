  ...
  <div>
    <div class="img-wrapper">
      <div class="lable-block">
        <span class="lable3" v-if="product.new"
          >{{ strReplace(String(discount)) }}%</span
        >
        <span class="lable4" v-if="product.sale">در حال فروش</span>
      </div>
      <div class="front">
      ...
      <div class="cart-info cart-wrap">
        <button
          ...
          variant="primary"
        >
          <i class="ti-shopping-cart py-1"></i>
        </button>
        ...
        <a
          ...
          variant="primary"
        >
          <i class="ti-search py-1" aria-hidden="true"></i>
        </a>
        <a
          href="javascript:void(0)"
          title="Comapre"
          ...
          variant="primary"
        >
          <i class="ti-reload py-1" aria-hidden="true"></i>
        </a>
      </div>
    </div>
