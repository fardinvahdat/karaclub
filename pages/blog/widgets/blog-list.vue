...
<div>
    ...
    >
      ...
      <div class="col-xl-6">
        <div class="blog-right justify-content-start">
          <div>
            <h6 class="text-right">{{ blog.date }}</h6>
            <nuxt-link :to="{ path: '/blog/blog-detail'}">
              <h4 class="text-right">{{blog.title}}</h4>
            </nuxt-link>
            <ul class="post-social text-right px-0">
              <li>نویسنده : {{blog.auther}}</li>
              <li>
                <i class="fa fa-heart"></i> 5 لایک
              </li>
              <li>
                <i class="fa fa-comments"></i> 10 نظر
              </li>
            </ul>
            <p class="text-right">{{blog.description}}</p>
          </div>
        </div>
      </div>
    </div>
