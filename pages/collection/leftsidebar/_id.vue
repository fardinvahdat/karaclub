                  ...
                  <div class="col-sm-12">
                    <div class="top-banner-wrapper">
                      ...
                      <div class="top-banner-content small-section">
                        <h4 class="text-right">مد</h4>
                        <h5 class="text-right">ارائه دهنده جدیدترین ترندهای مد و فشن</h5>
                          ...
                          <div class="col-12">
                            <div class="product-filter-content">
                              <div class="search-count">
                                <h6 class="text-right">نمایش 1-12 از {{ filterProduct.length }} نتیجه</h6>
                              </div>
                              <div class="product-page-filter">
                                <select @change="onChangeSort($event)">
                                  <option value="all">مرتب کردن</option>
                                  <option value="a-z">سایز (بزرگ به کوچک)</option>
                                  <option value="z-a">سایز (کوچک به بزرگ)</option>
                                  <option value="low">قیمت (زیاد به کم)</option>
                                  <option value="high">قیمت (کم به زیاد)</option>
                                </select>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="text-center section-t-space section-b-space" v-if="filterProduct.length == 0">
                              ...
                              <h3 class="mt-3">متاسفانه محصول مورد نظر پیدا نشد!!!</h3>
